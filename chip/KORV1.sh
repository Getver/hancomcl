...
--cdf-file /library_QC/library/Axiom_KORV1_1_Analysis.r1/Axiom_KORV1_1.r1.cdf \
--qcc-file /library_QC/library/Axiom_KORV1_1_Analysis.r1/Axiom_KORV1_1.r1.qcc \
--qca-file /library_QC/library/Axiom_KORV1_1_Analysis.r1/Axiom_KORV1_1.r1.qca \
...
--analysis-files-path /library_QC/library/Axiom_KORV1_1_Analysis.r1 \
--arg-file /library_QC/library/Axiom_KORV1_1_Analysis.r1/Axiom_KORV1_1_96orMore_Step2.r1.apt-genotype-axiom.AxiomGT1.apt2.xml \
--out-dir /workdir/${KEY}/01_Genotype \
--cel-files /workdir/${KEY}/${KEY}_celfile.txt \
...
--annotation-file /library_QC/library/Axiom_KORV1_1_Analysis.r1/Axiom_KORV1_1.na35.annot.db \
