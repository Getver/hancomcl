...
--cdf-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.cdf \
--qcc-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.qcc \
--qca-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.qca \
...
--analysis-files-path /library_QC/library/Axiom_KBAbetaB_r2_3 \
--arg-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB_96orMore_Step2.r2.apt-genotype-axiom.mm.SnpSpecificPriors.AxiomGT1.apt2.xml \
--out-dir /workdir/${KEY}/01_Genotype \
--cel-files /workdir/${KEY}/${KEY}_celfile.txt \
...
--special-snps-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.specialSNPs \
--ps2snp-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.ps2snp_map.ps \
--output-dir /workdir/${KEY}/05_Normalization \
--snp-specific-param-file /library_QC/library/Axiom_KBAbetaB_r2_3/Axiom_KBAbetaB.r2.probeset_genotyping_parameters.txt
...
--annotation-file /library_QC/library/Axiom_KBAbetaB_r2/Axiom_KBAbetaB.na36.r2.a1.annot.db \
