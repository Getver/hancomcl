...
ps_metrics() {
    CMD="
        /library_QC/tool/apt_2.11.6_linux_64_x86_binaries/bin/ps-metrics
...
ps_classification() {
    CMD="
        /library_QC/tool/apt_2.11.6_linux_64_x86_binaries/bin/ps-classification
            --metrics-file $OUTPUT_DIR/ps-metrics.txt
            --output-dir $OUTPUT_DIR
...
genotype() {
    CMD="
        /library_QC/tool/apt_2.11.6_linux_64_x86_binaries/bin/apt-summary-genotype-axiom
            --analysis-files-path $LIBRARY_DIR
