...
--cdf-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.cdf \
--qcc-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.qcc \
--qca-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.qca \
...
--analysis-files-path /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1 \
--arg-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA_96orMore_Step2.r7.with_mPCR.apt-genotype-axiom.mm.SnpSpecificPriors.AxiomGT1.apt2.xml \
--out-dir /workdir/${KEY}/01_Genotype \
--cel-files /workdir/${KEY}/${KEY}_celfile.txt \
...
--annotation-file /library_QC/library/Axiom_PMDA.r7/Axiom_PMDA.na36.r7.a8.annot.db \
...
/library_QC/tool/apt_2.12.0_linux_64_x86_binaries/bin/apt-genotype-axiom \
--analysis-files-path /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1 \
--arg-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.apt-genotype-axiom.AxiomCN_PS1.apt2.xml \
--cel-files /workdir/${KEY}/${KEY}_celfile.txt \
...
--analysis-files-path /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1 \
--arg-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.with_mPCR.apt-copynumber-axiom-cnvmix.AxiomCNVmix.apt2.xml \
--reference-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.cn_models \
--mapd-max 0.35 \
--waviness-sd-max 0.1 \
...
--special-snps /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA_Plus.r7.specialSNPs \
--y-restrict 0.2 \
...
# --multi-posterior-file /workdir/${name}/genotypes/AxiomGT1.snp-posteriors.multi.txt \
# --multi-metrics-file /workdir/${name}/SNPolisher/metrics.multi.txt \
...
/library_QC/tool/apt_2.12.0_linux_64_x86_binaries/bin/ps-classification \
--metrics-file /workdir/${KEY}/07_SNPolisher/metrics.txt \
--ps2snp-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.ps2multisnp_map.ps \
--species-type Human \
--cr-cutoff 95 \
--fld-cutoff 3.6 \
--het-so-cutoff -0.1 \
...
/library_QC/tool/apt_2.12.0_linux_64_x86_binaries/bin/apt-dmet-translation \
--batch-folder /workdir/${KEY}/06_Genotype \
...
--analysis-files-path /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1 \
--translate-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.na36.translation \
--metabolizer-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.metabolizer \
--annotation-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.r7.na36.dc_annot.csv \
...
--batch-folder /workdir/${KEY}/06_Genotype \
--cn-region-calls-file /workdir/${KEY}/05_CN/AxiomCNVMix.cnregioncalls.txt \
--snp-list-file /workdir/${KEY}/07_SNPolisher/Recommended.ps \
--annotation-file /library_QC/library/Axiom_PMDA_Plus.Analysis_r7.1/Axiom_PMDA.na36.r7.a8.annot.db \
