...
## library Axiom_KBA_v2_B 적용

# 기존 한국인칩 KORV1_1 과 KBAbetaA Merge 분석 방법, arg-file에 있는 library 기준

# apt-genotype-axiom --analysis-files-path .\Axiom_KORV1_1_Analysis_r3\ 
# --arg-file .\Axiom_KORV1_1_Analysis_r3\Axiom_KORV1_1_96orMore_Step1.r3.apt-genotype-axiom.AxiomGT1.apt2.xml 
# --do-rare-het-adjustment true 
# --out-dir .\Analysis_Output_Files\Test2 
# --cel-files .\cel_list.txt 
# --force TRUE         # 2가지 한꺼번에 분석하는 코드
# --log-file .\apt-genotype-axiom.log


KEY=$1
LIBRARY=$2
FOLDER='Axiom_KBA_v2_B'
...
--cdf-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.cdf \
--qcc-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.qcc \
--qca-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.qca \
...
--arg-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B_96orMore_Step2.r1.apt-genotype-axiom.mm.SnpSpecificPriors.AxiomGT1.apt2.xml \
--out-dir /workdir/${KEY}/01_Genotype \
--cel-files /workdir/${KEY}/${KEY}_celfile.txt \
...
--special-snps-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.specialSNPs \
--ps2snp-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.ps2snp_map.ps \
--output-dir /workdir/${KEY}/05_Normalization \
--snp-specific-param-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.r1.probeset_genotyping_parameters.txt
...
--annotation-file /library_QC/library/${FOLDER}/Axiom_KBA_v2_B.na36.r1.a1.annot.db \
